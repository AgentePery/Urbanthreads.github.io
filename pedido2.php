    ...
    <div class="card">
      <div class="carousel-card-img">
        <div class="carousel-inner">
          <img src="img/sueterviejo.png" class="active" alt="Suéter viejo" />
          <img src="img/sueternew.png" alt="Suéter nuevo" />
        </div>
      </div>
      <div class="card-content">
        <h3>Remaster Básico</h3>

        <form id="pedidoForm" action="pedido2.php" method="post" enctype="multipart/form-data">
