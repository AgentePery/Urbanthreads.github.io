...
<body>
    ...
    <div class="card">
      <div class="carousel-card-img">
        <div class="carousel-inner">
          <img src="img/chaquetavieja.png" class="active" alt="Producto 1 - Imagen 1" />
          <img src="img/chaquetanew.png" alt="Producto 1 - Imagen 2" />
        </div>
      </div>
      <div class="card-content">
        <h3>Remaster Creativo</h3>
        <form id="pedidoForm">
          ...
          <textarea id="especificaciones" name="especificaciones" rows="4" placeholder="Describe cómo quieres transformar tu prenda..."></textarea>
          <button type="submit" class="btn-link">ENVIAR PEDIDO</button>
        </form>
      </div>
    </div>
  </section>
  ...
  <script>
    ...
    // Alerta de envío y redirección
    document.getElementById('pedidoForm').addEventListener('submit', function(e) {
      e.preventDefault(); // Detiene envío real (para simulación)
